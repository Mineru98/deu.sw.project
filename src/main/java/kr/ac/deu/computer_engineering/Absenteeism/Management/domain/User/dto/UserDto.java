...
public class UserDto {
    ...
    @Max(value = 8, message = "이름은 8자를 초과할 수 없습니다.")
    private String name; // 직원 이름

    @NotNull(message = "아이디를 입력해주세요.")
    @Max(value = 16, message = "아이디는 16자를 초과할 수 없습니다.")
    private String username; // 로그인 계정

    @Min(value = 8, message = "비밀번호는 최소 8자를 넘어야 합니다.")
    @Max(value = 16, message = "비밀번호는 16자를 초과할 수 없습니다.")
